...
import com.hanyang.identity.identityservicev4mono.access.application.provisioning.AccountRoleProvisioningStatus;
...
@Entity
@Table(
        name = "account_role_identity_provider_bindings",
        uniqueConstraints = @UniqueConstraint(
                name = "uk_account_role_idp_bindings_key_provider",
                columnNames = {"account_id", "role_id", "provider"}
        )
)
@Getter
@Setter
@NoArgsConstructor
public class AccountRoleProvisioningJpaEntity extends AuditableEntity {
    ...
    private AccountRoleProvisioningStatus syncStatus;
