package com.hanyang.identity.identityservicev4mono.shared.persistence.converter;
...
public abstract class AbstractStringCodeEnumConverter<
        E extends Enum<E> & StringCodeEnum>
    ...
    public E convertToEntityAttribute(String dbData) {
        ...
        if (dbData.isBlank()) {
            throw new IllegalArgumentException(
                    "Blank code is not valid for enum "
    ...
    private static <
            E extends Enum<E> & StringCodeEnum>
    Map<String, E> buildValuesByCode(Class<E> enumType) {
        ...
        for (E enumValue : enumType.getEnumConstants()) {
            ...
            E existingValue =
                    result.putIfAbsent(code, enumValue);
