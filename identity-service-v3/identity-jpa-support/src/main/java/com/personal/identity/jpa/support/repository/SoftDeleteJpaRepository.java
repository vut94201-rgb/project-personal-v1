package com.personal.identity.jpa.support.repository;
...
@NoRepositoryBean
public interface SoftDeleteJpaRepository <T extends SoftDeletableEntity,ID> extends BaseJpaRepository<T,ID> {
